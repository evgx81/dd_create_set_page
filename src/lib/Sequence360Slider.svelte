            ...
            >
                ...
                {#if $render_task_result_data.sequences.length === 0 && is_image360_slider_initialized === false}
                    <div class="cloudimage-360-inner-box">
                        ...
                        <canvas
                            style="width: 1304px; font-size: 0px; height: 733.743px;"
                        ></canvas>
                    </div>
                {/if}
            </div>
            <div class={`slider-preview ${curr_style}`} data-name="preview-360">
                <div class="slider-preview__inner">
                    ...
                    <div
                        ...
                        data-name-preview-text-default="Here will be interactive photos"
                        data-name-preview-text-result="Render in progress"
                    >
                        {#if $render_in_progress}
                            Render in progress
                        {:else}
                            Here will be interactive photos
                        {/if}
                    </div>
                </div>
            </div>
